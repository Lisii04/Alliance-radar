...
: ${AMENT_CURRENT_PREFIX:="/workspaces/Alliance-radar/radar_ws/install/radar_serial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/radar_serial/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/radar_serial/environment/path.sh"
